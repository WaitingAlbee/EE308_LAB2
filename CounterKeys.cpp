...
public:
	...
	Count(const string arr[], int size, int level); 
	void isIgnoreSymbol(const string& s, int i, IgnoreList* situation);
...
Count::Count(const string arr[], int size, int level){
...
void Count::isIgnoreSymbol(const string& s, int i, IgnoreList* situation){
